...
// Auth information
global.pairNumber = "919633119220";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["919633119220", "919061949401"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["919633119220", "919061949401"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["919633119220"];
global.OwnerName = process.env.OWNER_NAME || "JIM";
global.BotName = process.env.BOT_NAME || "SENPAI";
global.packname = process.env.PACK_NAME || "SENPAI bot";
global.author = "By: JIM";
